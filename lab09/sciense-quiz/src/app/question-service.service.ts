...
export class QuestionServiceService {
  private questions = [
    ...
    { question: '¿Cuál es la velocidad de la luz en el vacío?', options: ['300,000 km/s', '150,000 km/s', '100,000 km/s'], correctAnswer: '300,000 km/s' }, { question: '¿Cuál es la unidad básica de la estructura de los ácidos nucleicos (ADN y ARN)?', options: ['Aminoácido', 'Nucleótido', 'Glucosa'], correctAnswer: 'Nucleótido' },
